...
import ce.evalution.ce_evaluation.evaluation.RecycleAdapter
import ce.evalution.ce_evaluation.evaluation.RecycleAdapterReport
...
class Subject_report : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val stringRequest = object : StringRequest(Request.Method.POST, url,
            Response.Listener { response ->
                ...
                recycle_list.adapter = RecycleAdapterReport(this,Subject,year,term,stdy,curi)
